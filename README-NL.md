...
3. Start `Codex-Transfer-Assistant.exe`.
...
3. Start `Codex-Transfer-Assistant.exe` vanaf de USB-stick of vanuit de back-upmap.
...
- `src/`: actuele Python-broncode van versie 3.0;
- `tests/`: vastgelegde testresultaten;
- `release/`: direct uitvoerbare Windows-release;
- `releases/3.0.0/`: portable releasepakket met checksum;
- `docs/ROADMAP.md`: roadmap en uitgangspunten;
- `legacy/Codex-Backup-Tools-v2/`: generiek fase-0/1-prototype;
- `build.ps1` en `test.ps1`: reproduceerbare build en zelftest.

Zie `BUILD.md` voor ontwikkelaarsinstructies en `SECURITY.md` voordat je echte
back-uppakketten verwerkt of deelt.
