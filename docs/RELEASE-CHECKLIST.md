...
This checklist publishes Codex Lifeboat 3.4.2 as a **pre-release for public
...
- Confirm that `git status --short` contains only intended 3.4.2 changes.
...
- Do not create the `v3.4.2` tag until the `main` CI run is green.
...
open <https://github.com/dkwolf1/Codex-Lifeboat/releases/tag/v3.4.2>.
...
Do not relabel 3.4.2 as stable solely because automated checks pass. Collect and
