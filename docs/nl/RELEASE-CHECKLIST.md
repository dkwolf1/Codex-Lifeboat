...
Deze checklist publiceert Codex Lifeboat 3.4.1 als **pre-release voor openbare
...
- Controleer dat `git status --short` alleen bedoelde 3.4.1-wijzigingen bevat.
...
- Maak tag `v3.4.1` pas nadat de CI-run van `main` groen is.
...
daarna <https://github.com/dkwolf1/Codex-Lifeboat/releases/tag/v3.4.1>.
...
Maak 3.4.1 pas stabiel nadat de nog ontbrekende fysieke Windows 10- en
