# Bekende grenzen van release 3.4.2
...
7. Formaat 2.4 registreert externe projectroots, permanente identiteiten, de
   volledige lokale Codex-inventaris en back-uplijn. Release 3.4.2 ondersteunt nu
...
13. Versie 3.4.2 is een openbare pre-release. De bron-, EXE- en uitgepakte-ZIP-tests
