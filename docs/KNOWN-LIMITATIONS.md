# Known limitations of release 3.4.1
...
7. Format 2.4 records external project roots, permanent identities, the complete
   local Codex inventory, and backup lineage. Release 3.4.1 implements reviewed
...
13. Version 3.4.1 is a public pre-release. Source, packaged-EXE, and extracted-ZIP
