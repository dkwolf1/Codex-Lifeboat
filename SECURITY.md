...
Version 3.4.1 is a public pre-release. Security-sensitive failures should still be
...
a backup and do not replace Windows Authenticode signing. The 3.4.1 executable is
